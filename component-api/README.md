...
- One `<id>.json` per component, the real, populated entries described above. `check-index-data.py` reports the current count and asserts it matches `index.html`'s own inventory.
